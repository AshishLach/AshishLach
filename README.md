...
- [DeFi AMM Math from First Principles — Part 1: Uniswap](https://techfund.jp/en/media/amm-math-first-principles-part1) – Constant product mechanics and liquidity provision.  
- [DeFi AMM Math from First Principles — Part 2: Curve](https://techfund.jp/en/media/amm-math-first-principles-part2-curve-v1) – StableSwap invariant and optimization strategies.  
- [Tornado Cash Demystified: Why Privacy Matters and How the Protocol Makes It Work](https://techfund.jp/en/media/why-privacy-matters-tornado-cash-demystified) – zk-SNARKs for anonymity in Ethereum.  
- [Breaking Down the Three Pillars of Zero Knowledge Proofs](https://techfund.jp/en/media/zero-knowledge-proofs-pillars-explained) – Completeness, soundness, and zero-knowledge principles.  
...
- Built and deployed full-stack applications used across enterprise clients:  
  - **DocVidya** — Brightcove and AWS-powered video education platform  
  ...
  - **Push Notifications System** — event-driven marketing automation pipeline  
...
## Education
- B.Tech in Computer Science JNTU affiliated Hyderabad (2012 – 2016)
